...
function setup() 
{
  ...
  star1 = createSprite(50,320,80,80);
  star1.addImage(starimg);
  star1.scale = 0.02;

  star2 = createSprite(320,50,80,80);
  star2.addImage(starimg);
  star2.scale = 0.02;

  starscore = createSprite(60,30,50,50);
...
function draw() 
{
  ...
  //collision btw star and fruit//

  if (collide(fruit,star1,40) === true ){
  star1.visible = false;
  starscore.changeAnimation('two',twostar);
}
  ...
  starscore.changeAnimation('one', onestar);
 }
